...
- **Dead Simple**: Copy a video URL, paste it, done. It's that easy.
...
### 🎯 Core Functionality
- **One-Click Downloads** - Paste a URL and go
...
### 🎨 User Interface
- **Native macOS Design** - Looks and feels like a real Mac app
...
- **Preset System** - Save your favorite settings for quick access
- **Debug Console** - Built-in troubleshooting tools when you need them

### 📦 Advanced Features
- **Custom File Naming** - Use templates to organize your downloads
- **Separate Output Folders** - Different locations for audio, video, and merged files
...
1. Download the latest `fetcha.stream.dmg` from [Releases](https://github.com/yourusername/fetcha-stream/releases)
2. Open the DMG file
...
```bash
brew install --cask fetcha-stream
```
...
git clone https://github.com/yourusername/fetcha-stream.git
cd fetcha-stream
...
2. **Open fetcha.stream**: Launch the app from your Applications folder
3. **Paste the URL**: The URL field will auto-populate if you have a video URL copied
4. **Click Download**: The video will download with the best quality automatically
...
2. Click the **Get Info** button to see available formats
...
Access Preferences with **⌘+,** or click the gear icon:
...
- **Separate Locations**: Different folders for audio/video/merged files
...
fetcha.stream supports **1000+ websites** including:
...
- **No Data Collection**: fetcha.stream doesn't collect or transmit any user data
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/fetcha-stream/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/fetcha-stream/discussions)
