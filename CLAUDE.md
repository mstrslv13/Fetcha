...
### PLEASE NOTE
_yt-dlp-MAX_ was the original project name I used prior to adopting the release name Fetcha. yt-dlp-MAX does not use any part of the actual yt-dlp source code to work, as it is only a Swift front-end for yt-dlp and to some degree, ffmpeg. 
